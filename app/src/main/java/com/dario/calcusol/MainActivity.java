...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAppBarConfiguration = new AppBarConfiguration.Builder(
                R.id.horaSolarFragment, R.id.irradianciaFragment, R.id.indexFragment, R.id.cieloClaroFragment , R.id.resultadosFragment, R.id.manualFragment, R.id.descargasFragment)
        ...
        editor.putString(getString(R.string.saved_alt), "1");
        editor.commit();
